...
type Job struct {
	ID               string    `json:"job_id" valid:"uuid" gorm:"type:uuid;primarykey;default:uuid_generate_v4()"`
	OutputBucketPath string    `json:"output_bucket_path" valid:"notnull"`
	Status           string    `json:"status" valid:"notnull"`
	Video            *Video    `json:"video" valid:"-"`
	VideoID          string    `json:"-" valid:"uuid" gorm:"column:video_id;type:uuid;not null"`
